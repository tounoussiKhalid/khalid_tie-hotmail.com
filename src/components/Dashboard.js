...
import CommandesPage from "../pages/admin/commandes";
        ...
        >
          <Toolbar className={classes.toolbar}>
            ...
            <Button
              ...
              onClick={async () => {
                props.logout();
                handleLogout().then(() => history.push("/"));
              }}
            >
              Logout
            </Button>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Paper className={classes.paper} style={{ padding: "0" }}>
                  <Switch>
                    <Route path="/home" exact component={ArticlesPage} />

                    <Route path="/home/categories" component={CategoriesPage} />
                    <Route path="/home/commandes" component={CommandesPage} />
